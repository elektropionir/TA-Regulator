...
// tested with:
// Arduino IDE: 1.8.16 and SAMD Boards Package 1.8.13 - https://github.com/arduino/ArduinoCore-samd/releases
...
/******************************************************************************
 ...
 Adafruit_Sensor.h
 Adafruit_BME280.h
 Encoder.h >> optional, not yet implemented
...
//    ArduinoOTA.begin(ip, "TA-regulator", "11000", InternalStorage);
    ArduinoOTA.begin(INADDR_NONE, "TA-pilot", "11000", InternalStorage);
